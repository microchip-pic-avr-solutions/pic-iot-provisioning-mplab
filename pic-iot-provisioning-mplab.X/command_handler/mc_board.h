...
#define MC_HELLOSTRING   ("Welcome to the PIC-IoT command handler!\r\n")
#define MC_BOARD_NAME    ("PIC-IoT WG")
#define MC_FW_NAME       ("PIC-IoT provisioning FW")
// Version of the complete firmware (as opposed to the Command handler version MC_VERSIONSTRING found in mc_parser.h)
#define MC_FW_VERSION    ("0.4.5")
